...
public class CollectionDocente {
	...
	public static List<Docente> getDocente(){
		if(docentes.isEmpty()) {
			docentes.add(new Docente(111,"Marcelo","Perez","cmpere@fi.unju.edu.ar",111111));
			docentes.add(new Docente(222, "Veronica", "Torres", "vtorres@fi.unju.edu.ar",222222));
			docentes.add(new Docente(333, "Juan Carlos", "Rodriguez", "juancarlos33@fi.unju.edu.ar",333333));
		}
		return docentes;
	}
